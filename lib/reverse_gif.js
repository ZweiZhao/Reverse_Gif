export default {
  /**
   * gif图片反转处理, 只接受gif
   * @param {string} cavnasID 需要一个用来接原图的canvas,提供id即可
   * @param {string} inputID 上传图片用的input[type=file],提供id即可
   * @param {string} resultImgID  显示最终结果的img标签,提供id即可
   */
